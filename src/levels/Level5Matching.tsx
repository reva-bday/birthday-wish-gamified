...
const MESSAGES_DATA = [
  ...
  { id: 'm4', text: "Can't wait for our next historical ruins trip!", friendName: "Vikram" },
  { id: 'm5', text: "Happy Birthday! Still waiting for you to finish reviewing my manuscript.", friendName: "Sneha" },
];
